...
class Statement {
  ...
  prepare(sql, callback = undefined) {
    if (
      ...
      throw new TypeError(
        "[node-odbc]: Incorrect function signature for call to statement.prepare({string}, {function}[optional])."
      );
    }
  ...
  bind(parameters, callback = undefined) {
    if (
      ...
      throw new TypeError(
        "[node-odbc]: Incorrect function signature for call to statement.bind({array}, {function}[optional])."
      );
    }
  ...
  execute(options, callback = undefined) {
    ...
    if (
      ...
      throw new TypeError(
        "[node-odbc]: Incorrect function signature for call to statement.execute({object}[optional], {function}[optional])."
      );
    }
  ...
  executeSync(options, callback = undefined) {
    if (options === undefined) {
      options = null;
    }
    ...
    if (typeof callback === "undefined") {
      ...
      return new Promise((resolve, reject) => {
        this.odbcStatement.executeSync(options, (error, result) => {
          if (error) {
            reject(error);
          } else {
            if (
  ...
  close(callback = undefined) {
    if (typeof callback !== "function" && typeof callback !== "undefined") {
      throw new TypeError(
        "[node-odbc]: Incorrect function signature for call to statement.close({function}[optional])."
      );
    }
